...
class TestDocFolder(LECTestCase):
    ...
    def test_renameAfterCreation(self):
        ...
        proj.invokeFactory('LECDocumentationFolder', 'foo')
...
class TestDocFolderView(LECTestCase):
