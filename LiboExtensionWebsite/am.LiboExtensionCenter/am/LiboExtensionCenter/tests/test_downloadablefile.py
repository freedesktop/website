...
class TestLECFile(LECTestCase):
    ...
    def afterSetUp(self):
        ...
        self.portal.lec.proj.releases['1.0'].invokeFactory('LECFile', 'file')
        self.file = self.portal.lec.proj.releases['1.0'].file
...
class TestLECFileView(LECTestCase):
    ...
    def test_direct_url(self):
        self.assertEqual('http://nohost/plone/lec/proj/releases/1.0/file',
          self.view.direct_url())

def test_suite():
    from unittest import TestSuite, makeSuite
    suite = TestSuite()
    suite.addTest(makeSuite(TestLECFile))
    suite.addTest(makeSuite(TestLECFileView))
    return suite
