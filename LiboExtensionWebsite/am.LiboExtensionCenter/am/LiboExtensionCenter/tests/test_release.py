...
class TestRelease(LECTestCase):
    ...
    def afterSetUp(self):
        ...
        self.release = self.portal.lec.proj.releases['1.0']
    ...
    def testEditFields(self):
        ...
        self.release.setDescription('A description for a LECRelease')
        self.assertEqual('A description for a LECRelease',
          self.release.Description())
        
        self.release.setText('Full description for a LECRelease')
        self.assertEqual('Full description for a LECRelease',
          self.release.getRawText())
        
        self.release.setChangelog('Added tests for LECRelease\nRejoiced')
        self.assertEqual('Added tests for LECRelease\nRejoiced',
    ...
    def testTitle(self):
        self.portal.lec.proj.setTitle('MyProject')
    ...
    def testGetRelatedFeatures(self):
        proj = self.portal.lec.proj
        
        proj.invokeFactory('LECImprovementProposalFolder', 'proposals')
        
        proj.proposals.invokeFactory('LECImprovementProposal', '1')
        proposal1 = proj.proposals['1']
        proposal1.setTitle('Proposal 1')
        proj.proposals.invokeFactory('LECImprovementProposal', '2')
        proposal2 = proj.proposals['2']
        proposal2.setTitle('Proposal 2')
        proj.proposals.invokeFactory('LECImprovementProposal', '3')
        proposal3 = proj.proposals['3']
        proposal3.setTitle('Proposal 3')
        proj.proposals.invokeFactory('LECImprovementProposal', '4')
    ...
    def testGetLicenseVocab(self):
        self.portal.lec.proj.setAvailableLicenses([
    ...
    def testGetCompatibilityVocab(self):
        self.portal.lec.proj.setAvailableVersions([
          '2.0',
          '1.0',
          ])
        self.assertEqual(
...
class TestReleaseView(LECTestCase):
    ...
    def test_is_outdated(self):
        ...
        self.portal.lec.proj.setUnsupportedVersions(['1.0'])
        self.resetView()
        try:
        ...
        self.portal.lec.proj.releases.invokeFactory('LECRelease', '2.0')
        self.resetView()
        self.failUnless(self.view.is_outdated())
