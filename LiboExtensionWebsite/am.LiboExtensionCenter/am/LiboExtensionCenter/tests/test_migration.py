...
from am.LiboExtensionCenter.setuphandlers import before_1_5
...
class TestMigration(LECTestCase):
    ...
    def afterSetUp(self):
        ...
        self.file = self.release.invokeFactory('LECFile',
                                               'my.egg') 
    ...
    def test_migration(self):
        ...
        for egg in SOME_EGGS:
            ...
            self.release.invokeFactory('LECFile', name)
