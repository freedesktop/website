...
class TestProposalFolder(LECTestCase):
    ...
    def afterSetUp(self):
        ...
        self.portal.lec.proj.invokeFactory('LECImprovementProposalFolder',
          'roadmap')
        self.roadmap = self.portal.lec.proj.roadmap
    ...
    def test_renameAfterCreation(self):
        ...
        proj.invokeFactory('LECImprovementProposalFolder', 'foo')
        proj.foo._renameAfterCreation()
        self.failUnless('roadmap' in proj.objectIds())
    
class TestProposalFolderView(LECTestCase):
    ...
    def test_state_title_internationalized(self):
        self.warning("*** TODO: FUTURE - LiboExtensionCenter is not "
          ...
          "internationalize LECProject, method getCategoryTitles, among "
          "other methods.")
    
    def test_improvement_proposals(self):
        self.roadmap.invokeFactory('LECImprovementProposal', '1')
        proposal1 = self.roadmap['1']
        proposal1.setTitle('Proposal 1')
        self.roadmap.invokeFactory('LECImprovementProposal', '3')
        proposal3 = self.roadmap['3']
        proposal3.setTitle('Proposal 3')
        self.roadmap.invokeFactory('LECImprovementProposal', '2')
