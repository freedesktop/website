...
class TestCenterSecurity(LECTestCase):
    ...
    def testProjectApproval(self):
        self.login('user2')
        self.portal.lec.invokeFactory('PLECProject', 'proj')
...
class TestProjectSecurity(LECTestCase):
    def afterSetUp(self):
        # Definitions for convenience
        self.wf_tool = getToolByName(self.portal, 'portal_workflow')
    ...
    def testRoadmapCreation(self):
        ...
        try:
            self.proj.invokeFactory('PLECImprovementProposalFolder', 'roadmap')
        except:
            self.fail('Project creator is unable to add a roadmap')
    
    def testProposalCreationAndApproval(self):
        self.login('user1')
        self.proj.invokeFactory('LECmprovementProposalFolder', 'roadmap')
    ...
    def testReleaseFolderDeletionAndCreation(self):
        ...
        try:
            self.proj.invokeFactory('PLECReleaseFolder', 'releases')
        except:
            self.fail('Project creator is unable to create Releases folder.')
    
class TestPloneHelpCenterIntegration(LECTestCase):
    def afterSetUp(self):
        # Definitions for convenience
        self.wf_tool = getToolByName(self.portal, 'portal_workflow')
    ...
    def testFAQCreationByOwner(self):
        ...
        #PloneHelpCenter type within a LECDocumentationFolder, we only test
    ...
    def testReleaseCreation(self):
        ...
        try: 
            self.lec.proj2.releases.invokeFactory('LECRelease', '0.1') 
        except:   
