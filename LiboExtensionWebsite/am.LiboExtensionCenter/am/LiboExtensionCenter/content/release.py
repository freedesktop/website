"""
$Id: LECRelease.py 2011-04-23 andreasma $
"""
...
LECReleaseSchema = OrderedBaseFolderSchema.copy() + Schema((
    ...
    StringField('id',
        ...
        widget=StringWidget(
            ...
            i18n_domain='liboextextensioncenter',
        ),
    ),
    ...
    ReferenceField('relatedFeatures',
        allowed_types=('LECImprovementProposal',),
        multiValued=1,
        enforceVocabulary=1,
...
class LECRelease(ATCTMixin, OrderedBaseFolder):
    ...
    archetype_name = 'Extension Release'
    immediate_view = default_view = 'lec_release_view'
    suppls_views = ()
    content_icon = 'download_icon.gif'
    schema = LECReleaseSchema
    _at_rename_after_creation = False
    global_allow = False

    allowed_content_types = ('LECFile', 'LECFileLink',)
...
registerType(LECRelease, config.PROJECTNAME)
