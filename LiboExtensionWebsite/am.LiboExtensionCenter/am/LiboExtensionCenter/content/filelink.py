"""
$Id: LECFileLink.py 19225 2006-02-13 05:50:18Z limi $
"""
...
LECFileLinkSchema = BaseSchema.copy() + Schema((
...
class LECFileLink(ATCTMixin, BaseContent):
...
registerType(LECFileLink, PROJECTNAME)
