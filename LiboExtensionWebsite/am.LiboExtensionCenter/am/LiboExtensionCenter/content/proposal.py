"""
$Id: LECImprovementProposal.py 2011-04-23  andreasma $
"""
...
LECImprovementProposalSchema = OrderedBaseFolderSchema.copy() + Schema((
...
class LECImprovementProposal(ATCTMixin, OrderedBaseFolder):
    """What used to be a PLIP."""

    implements(IImprovementProposalContent)

    archetype_name = 'Improvement Proposal'
    immediate_view = default_view = 'lec_improvements_view'
    suppl_views = ()
    content_icon = 'improvementproposal_icon.gif'
    schema = LECImprovementProposalSchema
    global_allow = False
...
registerType(LECImprovementProposal, PROJECTNAME)
