"""
$Id: LECImprovementProposalFolder.py 2011-04-23 andreasma $
"""
...
LECImprovementProposalFolderSchema = OrderedBaseFolderSchema.copy() + Schema((
...
class LECImprovementProposalFolder(ATCTMixin, BaseBTreeFolder):
    ...
    immediate_view = default_view = 'lec_roadmap'
    suppl_views = ()
    schema = LECImprovementProposalFolderSchema

    global_allow = False
    filter_content_types = True
    allowed_content_types = ('LECImprovementProposal',)
...
registerType(LECImprovementProposalFolder, PROJECTNAME)
