"""
$Id: LECDocumentationFolder.py 24410 2011-04-23 andreasma $
"""

from zope.interface import implements

from am.LiboExtensionCenter.interfaces import IDocumentationFolderContent
...
from am.LiboExtensionCenter.config import PROJECTNAME, DOCUMENTATION_ID
try:
    from Products.PloneHelpCenter.interfaces import IHelpCenterContent
except ImportError:
    IHelpCenterContent = None

LECDocumentationFolderSchema = OrderedBaseFolderSchema.copy() + Schema((
    ...
    LinesField(
        ...
        widget=LinesWidget(
                ...
                description_msgid="lec_audience_helpcenter",
                i18n_domain = "liboextensioncenter",
                ),
        ),
...
class LECDocumentationFolder(ATCTMixin, OrderedBaseFolder):
    ...
    schema = LECDocumentationFolderSchema
...
registerType(LECDocumentationFolder, PROJECTNAME)
