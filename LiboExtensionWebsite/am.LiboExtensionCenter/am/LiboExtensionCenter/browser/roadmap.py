...
from am.LiboExtensionCenter.browser.project import _upcoming_releases
...
class RoadmapView(BrowserView):
    ...
    def state_title(self, state):
        ...
        wf = wftool.lec_improvementproposal_workflow
    ...
    def improvement_proposals(self, review_state = []):
        ...
        query = {}
        query['portal_type'] = 'LECImprovementProposal'
