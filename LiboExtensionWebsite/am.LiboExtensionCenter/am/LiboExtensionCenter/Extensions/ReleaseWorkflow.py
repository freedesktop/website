...
# Original workflow id/title: lec_release_workflow/LEC Release workflow
...
def setupLEC_release_workflow(wf):
    "..."
    wf.setProperties(title='LEC Release workflow')
...
def createLEC_release_workflow(id):
    "..."
    ob = DCWorkflowDefinition(id)
    setupLEC_release_workflow(ob)
    return ob

def install ():
    addWorkflowFactory(createLEC_release_workflow,
                       id='lec_release_workflow',
