...
# Original workflow id/title: lec_area_workflow/LEC Area workflow
...
def setupLEC_area_workflow(wf):
    "..."
    wf.setProperties(title='LEC Area workflow')
...
def createLEC_area_workflow(id):
    "..."
    ob = DCWorkflowDefinition(id)
    setupLEC_area_workflow(ob)
    return ob

def install ():
    addWorkflowFactory(createLEC_area_workflow,
                       id='lec_area_workflow',
