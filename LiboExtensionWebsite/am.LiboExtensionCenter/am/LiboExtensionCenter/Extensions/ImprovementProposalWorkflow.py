...
# Original workflow id/title: lec_improvementproposal_workflow/LEC Improvement Proposal workflow
...
def setupLEC_improvementproposal_workflow(wf):
    "..."
    wf.setProperties(title='LEC Improvement Proposal workflow')
...
def createLEC_improvementproposal_workflow(id):
    "..."
    ob = DCWorkflowDefinition(id)
    setupLEC_improvementproposal_workflow(ob)
    return ob

def install ():
    addWorkflowFactory(createLEC_improvementproposal_workflow,
                       id='lec_improvementproposal_workflow',
