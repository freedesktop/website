...
# $Source: /cvsroot/mozilla/webtools/tinderbox2/src/default_conf/TreeData.pm,v $ 
# $Name:  $ 
...
addTreesFromFile("/var/www/tinderbox/tags/tag-list");
addTreesFromFile("/home/tinderbox/temp-list");
