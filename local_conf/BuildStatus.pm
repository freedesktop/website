...
# $Source: /cvsroot/mozilla/webtools/tinderbox2/src/default_conf/BuildStatus.pm,v $ 
# $Name:  $ 
...
%STATUS = (
           ...
           'dirty' => {
                         # when there were commits after starting the build
                         # only dummy-color for now
                         'html_color' => '#D0A5ED',
                         'hdml_char'=> '?',
                         'handler' => \&main::null,
                         'description'=> 'There have been commits after the build started',
                         'order' => 0,
                        },

           'fold' => {
                         # The buildslave rejected to build the tree for some reason or it
			 # was interrpted due to a timeout or similar (for buildbots mainly)
                         'html_color' => '#E8E8E8',
                         'hdml_char'=> ' ',
                         'handler' => \&main::null,
                         'description'=> 'Build interrupted or rejected by the buildslave',
                         'order' => 0,
                        },
          );
