...
<p>Go-oo provide a built-in <code>.docx</code><br>
import filter. (<a href="go-oox.docx">sample</a>).</p>
<p><a href="go-oox-docx.png">
<img src="go-oox-docx-thumb.png" alt="screenshot of XLSX import"/></a></p>
</div>

<div class="discover-tile">
<h4 id="xlsx-support">OpenXML / XLSX support</h4>
<p>Go-oo provide a built-in <code>.xlsx</code><br>
mport filter. (<a href="go-oox.xlsx">sample</a>).</p>
<p><a href="go-oox-xlsx.png">
<img src="go-oox-xlsx-thumb.png" alt="screenshot of XLSX import"/></a></p>
</div>

<div class="discover-tile">
<h4 id="docx-support">OpenXML / PPTX support</h4>
<p>Go-oo provide a built-in <code>.pptx</code><br>
mport filter. (<a href="go-oox.pptx">sample</a>).</p>
<p><a href="go-oox-pptx.png">
<img src="go-oox-pptx-thumb.png" alt="screenshot of PPTX import"/></a></p>
</div>

<div class="discover-tile">
<h4 id="fields-support">Rich fields support</h4>
<p>Go-oo provides a powerful and<br>
interoperable fields implementation<br>
with
<a href="http://qa.openoffice.org/issues/show_bug.cgi?id=7644">nesting</a>,
<a href="http://qa.openoffice.org/issues/show_bug.cgi?id=33737">in-place editing</a>,<br>
<a href="http://qa.openoffice.org/issues/show_bug.cgi?id=29508">multiple fonts</a> &amp;
<a href="http://qa.openoffice.org/issues/show_bug.cgi?id=69332">nested conditionals</a>.<br>
(<a href="go-fields.doc">sample doc</a>)<br></p>
<p><a href="go-fields.png">
<img src="go-fields-thumb.png" alt="go-oo screenshot showing powerful fields import"/></a></p>
</div>
...
<p>Go-oo can run in the background<br>
for a lightning second start. (Set via<br>
...
<p>Go-oo has improved interoperability with Excel, <br>
such as the ability to implicitly convert strings to <br>
...
<p><a href="mono-sample.png">
<img src="mono-sample-thumb.png" alt="Screenshot of Automation with Mono"/></a></p>
</div>

<div class="discover-tile">
<h4 id="vba-support">VBA support</h4>
<p>Go-oo provides VBA macro support <br>
for OpenOffice.org (<a href="go-vba-hypo.xls">sample doc</a>).</p>
...
<p>Go-oo renders Chinese much more pleasantly, using a<br>
...
<p>Go-oo imports graphics in the<br>
WordPerfect WPG format<br>
which supplements Go-oo's<br>
WordPerfect importer.<br>
...
<p>Go-oo renders EMF+ content, giving a far better <br>
...
<p>Go-oo provides a built-in <br>
